package com.example.pc.naverlogin1;
...
/*
file > project structure > + >  import JAR/AAR  >  naveridlogin_android_sdk_4.2.0 추가

앱 gradle
compile project(path: ':naveridlogin_android_sdk_4.2.0')
    ...
    private class RequestApiTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String content) {//doInBackground 에서 리턴된 값이 여기로 들어온다.
            try {
                ...
                tv_mail.setText(String.valueOf(jsonObject));//메일 란 채우기
            }
            catch (Exception e){
                e.printStackTrace();
            }
